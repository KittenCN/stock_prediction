...
if __name__=="__main__":
    ...
    if model_mode=="LSTM":
        ...
        model=TransformerModel(input_dim=INPUT_DIMENSION, d_model=512, nhead=8, num_layers=6, dim_feedforward=2048, output_dim=OUTPUT_DIMENSION)
        test_model=TransformerModel(input_dim=INPUT_DIMENSION, d_model=512, nhead=8, num_layers=6, dim_feedforward=2048, output_dim=OUTPUT_DIMENSION)
